...
from dataset_sh import get_dataloaders
...
class SAINTSYNModule(pl.LightningModule):
    ...
    def validation_epoch_end(self, validation_ouput):
        ...
        acc = accuracy_score(labels, out.round())
            ...
            #self.best_auc = auc
           # self.best_model = SAINTSYNModule()
    ...
    #def on_validation_epoch_end(self):
        #torch.save(self.best_model_state_dict, './newsaintsynednet.pt')
...
if __name__ == "__main__":
    ...
    #torch.save(trainer,'./newnewsaintsynednet.pkl') 